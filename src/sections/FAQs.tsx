    ...
    <section className="section" id="faqs">
      ...
      <div className="mt-10 md:mt-16 lg:mt-20 ">
        {faqs.map(({ question, answer }, faqIndex) => (
          <div
            key={question}
            className="border-t last:border-b border-stone-500 border-dotted py-6 md:py-8 lg:p-10 relative isolate group/faq"
            onClick={() =>
          ...
          >
            ...
            <AnimatePresence>
              {faqIndex === selectedIndex && (
                ...
                >
                  <p className="text-xl lg:text-2xl mt-4  ">{answer}</p>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
